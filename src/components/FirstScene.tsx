    ...
    >
      <div className="flex w-4/5 items-center">
        <div className="flex flex-[70%] justify-end gap-2">
          ...
          <div
            className="w-fit rounded-full border-2 border-orange-500 bg-orange-500 p-4 text-white"
            id="arrow-2"
          >
            Dentals
          </div>
      ...
      <div className="absolute left-1/2 top-1/2 z-[100] size-[150px] -translate-x-1/2 -translate-y-1/2 bg-white" />
      <div className="absolute left-1/2 top-1/2 z-[1000] flex -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-2">
        <div
          className="size-fit rounded-full bg-orange-500 p-4 text-white"
          id="bus"
        >
          <svg
            stroke="currentColor"
        ...
        <div className="text-2xl font-bold text-orange-500" id="text">
          Dennies
        </div>
      </div>
    </section>
